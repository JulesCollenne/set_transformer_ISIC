...
# I made this code because:
# previous version was using always the same patients in train, val and test
# and I think it's more rigorous to change it through multiple runs
# like, to make a cross validation
# So, 5 folds of 20% data each : train=3folds, val and test=1fold
